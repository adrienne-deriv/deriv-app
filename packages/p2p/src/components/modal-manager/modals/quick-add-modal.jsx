...
import 'Components/my-ads/quick-add-modal.scss';

const QuickAddModal = () => {
    const { my_ads_store, modal_store, my_profile_store } = useStores();
    const { advert } = modal_store.props;
    console.log('props passed to QuickAddModal', advert);
